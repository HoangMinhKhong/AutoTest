...
//	  
//	  String errorMesagePass = driver.findElement(By.xpath("//div[@class='account-login']//li//span")).getText();
//	  System.out.println("Error pass: " + errorMesagePass);
//	  
//	  //so sanh ket qua
//	  assertEquals("Invalid login or password.", errorMesagePass);
//	  
//  }
  ...
  public void test_day1_firefox() {
	  ...
	  driverFirefox.findElement(By.xpath("//input[@id='pass']")).sendKeys("123123123");
	  
	  //tim den va click button login
	  driverFirefox.findElement(By.xpath("//button[@id=\"send2\"]")).click();
	  
	  String errorMesagePassFire = driverFirefox.findElement(By.xpath("//div[@class='account-login']//li//span")).getText();
	  System.out.println("Error pass: " + errorMesagePassFire);
	  
	  //so sanh ket qua
	  assertEquals("Invalid login or password.", errorMesagePassFire);
  }
